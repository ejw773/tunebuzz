...
const accessToken = "BQCRjFgpfEqPhweGZTgXRRZIaOEA8rkqzJWqgzEaPvJqkFT27AlYZPnVEj78MihQRNQrhoDjQ0fecoe5oJwN5oSvAhwL_iRKWyKs7EiBuoXzv0zapaBIe-3ds15LRI8celag2nU6hGmfHIcTmcZ9y2QgpQfRUlZy0A"
            ...
            response.json().then(
                (data) => {
                    ...
                    for (let i = 0; i < data.tracks.length; i++) {
                        ...
                        console.log(data.tracks[i].genre);
